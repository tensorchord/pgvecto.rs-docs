...
- Type: boolean
- Default: `false`
- See also: [Pre And Post Filtering](../advanced-features/pre-and-post-filtering)

#### `vchordrq.io_search` <badge type="tip" text="since v0.4.0" />

- Description: This GUC parameter controls the I/O prefetching strategy for reading bit vectors in vector search, which can slightly impact search performance on disk-based vectors.
- Type: string
...
- See also: [Prefetch Mode](../advanced-features/cold-start-optimization#prefetch-mode)
