...
> - When dealing with large tables, it will cost huge time and memory for `build.internal`. You can refer to [External Build](./external-build) to have a better experience.
