...
#### `vchordrq.maxsim_refine` <badge type="tip" text="since v0.3.0" /> {#search-parameters-vchordrq-maxsim-refine}
...
#### `vchordrq.maxsim_threshold` <badge type="tip" text="since v0.3.0" /> {#search-parameters-vchordrq-maxsim-threshold}
