...
For more usage of `vecf16`, please refer to [vector types](../reference/vector-types/vecf16).

### Sparse vector

`svector` type is a sparse vector type. It stores a vector in a sparse format. It is suitable for vectors with many zeros.

For more usage of `svector`, please refer to [vector types](../reference/vector-types/svector).
...
For more usage of `bvector`, please refer to [vector types](../reference/vector-types/bvector).
